...
// በ Schema-ህ መሰረት የተስተካከለ Interface
interface Education {
    id: number;
    school: string;
    degree: string;
...
export const EducationForm: React.FC<Props> = ({ educationList, setEducation }) => {
    ...
    const addEducation = () => {
        const newEdu: Education = {
            id: Date.now(), // ለጊዜው በሰዓት ID እንስጠው
            school: "",
            degree: "",
            fieldOfStudy: "",
            startDate: "",
                ...
                {educationList.map((edu, index) => (
                    <div key={edu.id} className="group relative bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {/* Field of Study - schema: fieldOfStudy */}
                            <div className="space-y-2">
                            ...
                            {/* Dates - schema: startDate, endDate */}
                            <div className="space-y-2">
                            ...
                            <div className="md:col-span-2 space-y-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="e.g. Graduated with 3.8 GPA. Specialized in Software Engineering..."
                                />
                            </div>
